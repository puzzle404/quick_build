...
class Qb::TabsComponent < ViewComponent::Base
  ...
  def tab_style(active)
    ...
    "height:40px;padding:0 12px;background:transparent;border:none;border-bottom:2px solid #{border};color:#{color};font-size:13px;font-weight:#{weight};display:inline-flex;align-items:center;gap:6px;margin-bottom:-1px;text-decoration:none;cursor:pointer;"
  end
end
