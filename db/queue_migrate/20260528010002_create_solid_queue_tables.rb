...
# Solid Queue (Active Job en producción) sobre la misma Postgres. Espeja
# db/queue_schema.rb como migración idempotente para que el release phase
# pueda crearlas sobre una base ya existente.
class CreateSolidQueueTables < ActiveRecord::Migration[7.2]
  def change
    ...
    %i[
      ...
      unless foreign_key_exists?(table, :solid_queue_jobs, column: :job_id)
