...
RSpec.describe 'Dashboard v2 components', type: :component do
  describe Constructors::DashboardV2::HeroCardComponent do
  ...
  describe Constructors::DashboardV2::KpiBlockComponent do
  ...
  describe Constructors::DashboardV2::EvolutionChartComponent do
  ...
  describe Constructors::DashboardV2::ProjectsTableComponent do
  ...
  describe Constructors::DashboardV2::ActivityFeedComponent do
  ...
  describe Constructors::DashboardV2::AlertStripComponent do
  ...
  describe Constructors::DashboardV2::UpcomingStagesComponent do
