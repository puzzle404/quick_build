...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<activesupport>.freeze, ["> 5.x".freeze])
  s.add_runtime_dependency(%q<activemodel>.freeze, ["> 5.x".freeze])
  s.add_runtime_dependency(%q<builder>.freeze, ["~> 3.1".freeze])
  s.add_development_dependency(%q<rake>.freeze, ["~> 10.0".freeze])
  s.add_development_dependency(%q<activerecord>.freeze, ["> 5.x".freeze])
