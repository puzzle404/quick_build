# -*- encoding: utf-8 -*-
# stub: rubocop 1.79.2 ruby lib

Gem::Specification.new do |s|
  s.name = "rubocop".freeze
  s.version = "1.79.2".freeze

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.metadata = { "bug_tracker_uri" => "https://github.com/rubocop/rubocop/issues", "changelog_uri" => "https://github.com/rubocop/rubocop/releases/tag/v1.79.2", "documentation_uri" => "https://docs.rubocop.org/rubocop/1.79/", "homepage_uri" => "https://rubocop.org/", "rubygems_mfa_required" => "true", "source_code_uri" => "https://github.com/rubocop/rubocop/" } if s.respond_to? :metadata=
  ...
  s.add_runtime_dependency(%q<rubocop-ast>.freeze, [">= 1.46.0".freeze, "< 2.0".freeze])
