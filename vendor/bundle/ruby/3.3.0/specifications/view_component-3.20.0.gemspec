# -*- encoding: utf-8 -*-
# stub: view_component 3.20.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<activesupport>.freeze, [">= 5.2.0".freeze, "< 8.1".freeze])
  ...
  s.add_development_dependency(%q<turbo-rails>.freeze, ["~> 1".freeze])
  ...
  s.add_development_dependency(%q<drb>.freeze, [">= 0".freeze])
